!function(e) {
  ...
  setTimeout((function() {
      (()=>{
          var e = document.querySelector("#page-with-search-in-header");
          if (console.log("out...."),
          console.log(e),
          e) {
              console.log("in....");
              var t = document.querySelector("#page-content .cmp-experiencefragment--header .searchbar");
              console.log(t),
...
, function(e, t) {
  document.addEventListener("DOMContentLoaded", ()=>{
      document.querySelector(".pager") && (()=>{
          const e = {}
            , t = document.querySelectorAll("[data-condition]");
          if (t.length > 0) {
              const n = document.createElement("label");
              n.value = "filter",
              n.innerText = "Filter Content:";
              const r = document.createElement("div");
              r.classList.add("filter"),
              r.appendChild(n);
              const o = document.createElement("option");
              o.innerText = "Remove Filters",
              ...
              i.addEventListener("change", e=>{
                  t.forEach(t=>{
                      ...
                      "" !== e.target.value && t.dataset.condition.split(":")[1] !== e.target.value && (t.style.display = "none")
                  }
                  )
              }
              ),
              t.forEach(t=>{
                  const [n,r] = t.dataset.condition.split(":");
                  e[n] || (e[n] = []),
                  e[n].includes(r) || e[n].push(r)
              }
              ),
              ...
              r.appendChild(i),
              document.querySelector(".pager").appendChild(r)
          }
      }
      )()
  }
...
, function(e, t, n) {
  n(3)((function(e) {
      "use strict";
      var t, n, r, o, i, a, s;
      null != (s = e(a = ".languagenavigation").not("[data-lang-nav-processed='true']")) && 1 == s.length && (e(s).attr("data-lang-nav-processed", !0),
      n = void 0 !== (n = e(a + " .cmp-languagenavigation__item--active > .cmp-languagenavigation__item-link").attr("lang")) ? n : "Language",
      t = void 0 !== (t = e(a + " .cmp-languagenavigation__item--level-0.cmp-languagenavigation__item--active").css("background-image")) ? t.replace('"', "'").replace('"', "'") : "none",
      r = `<div id="langNavToggleHeader" class="cmp-languagenavigation--langnavtoggle">             <a  href="#langNavToggle" aria-label="Toggle Language">${n}</a>             <img id="lang-chevron" src='data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="%238E8E8E" class="bi bi-chevron-down" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/></svg>'/>             </div>`,
      e(s).prepend(r),
      e("#langNavToggleHeader").click((function() {
          i = e(this).position().left,
          o = e(this).position().top + 32,
          console.log(o, i),
          e(a + " .cmp-languagenavigation").css({
              left: i
          }),
          e(a + " .cmp-languagenavigation").css({
              top: o
          }),
          e(a + " .cmp-languagenavigation").toggleClass("showMenu"),
          e("#langNavToggleHeader").toggleClass("open")
      }
      )),
      window.onclick = function(t) {
          console.log(t.target),
          t.target.matches("#langNavToggleHeader") || t.target.matches("#lang-chevron") || !e("#langNavToggleHeader").hasClass("open") || (e(a + " .cmp-languagenavigation").removeClass("showMenu"),
          console.log("removed"),
          e("#langNavToggleHeader").removeClass("open"))
      }
      )
  }
  ))
...
*/
      function(e) {
          var t, n, r, o, i, a, s, u, l, c, f, p, d, h, g, v, m, y, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0, C = 0, E = ue(), S = ue(), k = ue(), A = ue(), N = function(e, t) {
              return e === t && (f = !0),
              0
              ...
              for (var n = 0, r = e.length; n < r; n++)
                  if (e[n] === t)
                      return n;
              return -1
          }, M = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", I = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", $ = "\\[" + R + "*(" + I + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + R + "*\\]", W = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)", _ = new RegExp(R + "+","g"), F = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), B = new RegExp("^" + R + "*," + R + "*"), z = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), G = new RegExp(R + "|>"), X = new RegExp(W), U = new RegExp("^" + I + "$"), V = {
              ID: new RegExp("^#(" + I + ")"),
              CLASS: new RegExp("^\\.(" + I + ")"),
              TAG: new RegExp("^(" + I + "|[*])"),
              ATTR: new RegExp("^" + $),
              ...
              filter: {
                  ...
                  ATTR: function(e, t, n) {
                      return function(r) {
                          var o = se.attr(r, e);
                          return null == o ? "!=" === t : !t || (o += "",
                          "=" === t ? o === n : "!=" === t ? o !== n : "^=" === t ? n && 0 === o.indexOf(n) : "*=" === t ? n && o.indexOf(n) > -1 : "$=" === t ? n && o.slice(-n.length) === n : "~=" === t ? (" " + o.replace(_, " ") + " ").indexOf(n) > -1 : "|=" === t && (o === n || o.slice(0, n.length + 1) === n + "-"))
                      }
                  },
                  ...
                  (s = k(e, function(e, t) {
                      var n = t.length > 0
                        ...
                        , i = function(i, a, s, u, c) {
                          var f, h, v, m = 0, y = "0", x = i && [], b = [], w = l, C = i || o && r.find.TAG("*", c), E = T += null == w ? 1 : Math.random() || .1, S = C.length;
                              ...
                              var s = this
                                ...
                                , l = function() {
                                  ...
                                  if (!(e < i)) {
                                      ...
                                      m(l) ? o ? l.call(n, a(i, t, I, o), a(i, t, $, o)) : (i++,
                                      l.call(n, a(i, t, I, o), a(i, t, $, o), a(i, t, I, t.notifyWith))) : (r !== I && (s = void 0,
                                      u = [n]),
                                      (o || t.resolveWith)(s, u))
                                  }
                              }
      ...
      C.ready.then = F.then,
      "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? n.setTimeout(C.ready) : (x.addEventListener("DOMContentLoaded", B),
      ...
      C.fn.extend({
          data: function(e, t) {
              ...
              return "object" == typeof e ? this.each((function() {
                  ...
                  var n;
                  if (i && void 0 === t)
                      return void 0 !== (n = K.get(i, e)) || void 0 !== (n = te(i, e)) ? n : void 0;
                  this.each((function() {
                      K.set(this, e, t)
                  }
                  ))
      ...
      C.event = {
          ...
          special: {
              ...
              click: {
                  setup: function(e) {
                      var t = this || e;
                      return ge.test(t.type) && t.click && j(t, "input") && Ne(t, "click", Ee),
                      !1
                  },
                  trigger: function(e) {
                      var t = this || e;
                      return ge.test(t.type) && t.click && j(t, "input") && Ne(t, "click"),
                      !0
                  },
                  _default: function(e) {
                      var t = e.target;
      ...
      C.each({
          ...
          C.event.special[e] = {
              ...
              handle: function(e) {
                  ...
                  return o && (o === r || C.contains(r, o)) || (e.type = i.origType,
      ...
      function Re(e, t, n, r) {
          ...
          if (p && (i = (o = Te(t, e[0].ownerDocument, !1, e, r)).firstChild,
          1 === o.childNodes.length && (o = i),
          i || r)) {
              for (s = (a = C.map(xe(o, "script"), He)).length; f < p; f++)
                  l = o,
                  f !== d && (l = C.clone(l, !0, !0),
              ...
              if (s)
                  ...
                  f = 0; f < s; f++)
                      l = a[f],
                      me.test(l.type || "") && !J.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
      ...
      function Be(e, t, n) {
          ...
          !v.pixelBoxStyles() && $e.test(a) && Fe.test(t) && (r = s.width,
          o = s.minWidth,
          i = s.maxWidth,
      ...
      function tt(e, t, n) {
          ...
          return (!v.boxSizingReliable() && o || !v.reliableTrDimensions() && j(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === C.css(e, "display", !1, r)) && e.getClientRects().length && (o = "border-box" === C.css(e, "boxSizing", !1, r),
          (i = s in e) && (a = e[s])),
      ...
      C.each(["height", "width"], (function(e, t) {
          C.cssHooks[t] = {
              get: function(e, n, r) {
                  if (n)
                      return !Ye.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, r) : _e(e, Je, (function() {
                          return tt(e, t, r)
                      }
                      ))
              },
      ...
      C.extend({
          ...
          ajax: function(e, t) {
              ...
              e = void 0),
              t = t || {};
              var r, o, i, a, s, u, l, c, f, p, d = C.ajaxSetup({}, t), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? C(h) : C.event, v = C.Deferred(), m = C.Callbacks("once memory"), y = d.statusCode || {}, b = {}, w = {}, T = "canceled", E = {
                  readyState: 0,
              ...
              delete d.data),
              !1 === d.cache && (o = o.replace(qt, "$1"),
              p = (Et.test(o) ? "&" : "?") + "_=" + Ct.guid++ + p),
              d.url = o + p),
              d.ifModified && (C.lastModified[o] && E.setRequestHeader("If-Modified-Since", C.lastModified[o]),
              ...
              function S(e, t, a, u) {
                  ...
                  f ? (d.ifModified && ((w = E.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w),
      ...
      C.ajaxPrefilter("json jsonp", (function(e, t, r) {
          ...
          if (s || "jsonp" === e.dataTypes[0])
              ...
              s ? e[s] = e[s].replace(Ut, "$1" + o) : !1 !== e.jsonp && (e.url += (Et.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
      ...
      C.parseHTML = function(e, t, n) {
          ...
          i = !n && [],
          (o = D.exec(e)) ? [t.createElement(o[1])] : (o = Te([e], t, i),
...
, function(e, t) {
  e.exports = (e,t,n)=>({
      ...generateStyles(t, parseInt(n)),
      [`& > .aem-GridColumn.aem-GridColumn--${t}--newline`]: {
          display: "block",
          clear: "both !important"
      },
      [`& > .aem-GridColumn.aem-GridColumn--${t}--none`]: {
          display: "block",
          clear: "none !important",
          float: "left"
      },
      [`& > .aem-GridColumn.aem-GridColumn--${t}--hide`]: {
          display: "none"
      }
  })
}
, function(e, t) {
  const n = (e,t,n=0)=>{
      ...
      for (; n <= t; )
          r = {
              ...r,
              [`& > .aem-GridColumn.aem-GridColumn--${e}--${n}`]: {
                  float: "left",
                  clear: "none",
                  width: 100 * n / t + "%"
              },
              [`& > .aem-GridColumn.aem-GridColumn--offset--${e}--${n}`]: {
                  "margin-left": 100 * n / t + "%"
              }
          },
          n++;
...
, function(e, t) {
  var n = window.innerWidth
    ...
    , i = function(e) {
      return r = o(e).clientX
  }
    , a = function(e) {
      var t, i, a = null === (t = document.querySelector(".cmp-pager__next a")) || void 0 === t ? void 0 : t.getAttribute("href"), s = null === (i = document.querySelector(".cmp-pager__prev a")) || void 0 === i ? void 0 : i.getAttribute("href"), u = o(e).clientX, l = r < u ? "prev" : "next";
      n / 2 < Math.abs(r - u) && ("prev" === l && s && (window.location.href = s),
      "next" === l && a && (window.location.href = a))
  };
  document.addEventListener("DOMContentLoaded", (function() {
      var e = document.querySelector("#topic-page")
        , t = document.querySelector("#topic-container")
        , n = document.querySelector("#table-of-contents");
      if (e && t && n) {
          var r = document.createElement("button");
          r.classList.add("toc-toggle"),
          r.setAttribute("aria-label", "Toggle Table of Contents"),
          e.prepend(r),
